...
def insert():
    ...
    if not id_tipo_predio or not descripcion or not ruc or not correo or not telefono or not direccion or not idubigeo or not id_persona or not url_imagen:
        result["status_code"]=400
        result["msg"]="faltan datos"
        return jsonify(result), 400
    predio=Predio(id_tipo_predio,descripcion,ruc,correo,telefono,direccion,idubigeo,id_persona,url_imagen)
